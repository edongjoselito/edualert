                                    ...
                                    <div class="card-body table-responsive">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $row->firstName.', '.$row->lastName; ?> <?php if(!empty($row->middleName)){echo substr($row->middleName, 0, 1).'.';} ?></td>
                                                    <td><?= $row->email; ?></td>
                                                    <td><?= $pos[$row->position]; ?></td>
                                                    <td>
                                                        <a class="btn btn-primary btn-sm" href="<?= base_url(); ?>pages/user_update/<?= $row->user_id; ?>">Edit</a>
                                                        <a href="#cp" class="open-AddBookDialog btn btn-warning btn-sm waves-effect waves-light" data-id="<?= $row->user_id; ?>" data-animation="newspaper" data-plugin="custommodal" data-overlayspeed="200" data-overlaycolor="#36404a">Change Password</a>
                                                        <a href="#profile" class="open-AddBookDialog btn btn-primary btn-sm waves-effect waves-light" data-id="<?= $row->user_id; ?>" data-animation="slit" data-plugin="custommodal" data-overlayspeed="100" data-overlaycolor="#36404a">Change profile</a>
                                                    
                                                        
                                                        <?php if($this->session->position == 'admin'){ ?>
                                                        <a onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm" href="<?= base_url(); ?>pages/user_delete/<?= $row->user_id; ?>">Delete</a>
                                                        <?php } ?>
